...
module.exports = {
  ...
  getBankAccount: function getBankAccount(declaration) {
    return toSafestNumber(_.reduce(_.get(declaration, 'banks.45'), (sum, bank) => sum + toUAH(bank.sum, bank.sum_units), 0));
  },
  ...
  getFlatArea: function getFlatArea(declaration) {
    return toSafestNumber(_.reduce(_.get(declaration, 'estate.25'), (sum, flat) => sum + toSquareMeters(flat.space, flat.space_units), 0));
  },
  ...
  getHouseArea: function getHouseArea(declaration) {
    return toSafestNumber(_.reduce(_.get(declaration, 'estate.24'), (sum, house) => sum + toSquareMeters(house.space, house.space_units), 0));
  },
  ...
  getLandArea: function getLandArea(declaration) {
    return toSafestNumber(_.reduce(_.get(declaration, 'estate.23'), (sum, land) => sum + toSquareMeters(land.space, land.space_units), 0));
  },
  ...
  getFamilyFlatArea: function familyFlatArea(declaration) {
    return toSafestNumber(_.reduce(_.get(declaration, 'estate.31'), (sum, flat) => sum + toSquareMeters(flat.space, flat.space_units), 0));
  },
  ...
  getFamilyHouseArea: function getFamilyHouseArea(declaration) {
    return toSafestNumber(_.reduce(_.get(declaration, 'estate.30'), (sum, house) => sum + toSquareMeters(house.space, house.space_units), 0));
  },
  ...
  getFamilyLandArea: function getFamilyLandArea(declaration) {
    return toSafestNumber(_.reduce(_.get(declaration, 'estate.29'), (sum, land) => sum + toSquareMeters(land.space, land.space_units), 0));
  },
