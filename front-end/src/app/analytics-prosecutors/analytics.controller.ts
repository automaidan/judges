...
interface IAnalyticsProsecutorsController {
...
class AnalyticsProsecutorsController implements IAnalyticsProsecutorsController {
    public units: string;
...
export {AnalyticsProsecutorsController};
