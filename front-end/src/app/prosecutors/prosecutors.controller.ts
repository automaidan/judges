...
interface IScope extends angular.IScope {
    ...
    fullMode: boolean;
    _api: any;
    vm: ProsecutorsListController;
}

export function plist(): angular.IDirective {
    return {
        restrict: 'E',
        scope: {
            data: '=data',
        ...
        templateUrl: 'app/prosecutors/prosecutors-list.view.html',
...
// export class ProsecutorsListController {
//     private _api: any;
//
//     /* @ngInject */
//     constructor(Api: any) {
...
export class ProsecutorsListController {
    ...
    getPartials() {
        this.partialData = this.data.slice(this.skipped, this.skipped + this.limit);
    ...
    search(region: string, stigma: string) {
        return this.filterByRegions(region)
            ...
            .then(() => {
                ...
                this.data = filtered.length > 0 ? filtered : [{n: 'Прокурора не знайдено, спробуйте ще..', r: '', k: ''}];
